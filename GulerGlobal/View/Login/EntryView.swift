...
struct EntryView: View {
    ...
    var body: some View {
        ZStack {
            BasicEntry(username: $dataModel.username, password: $dataModel.password, loginActionText: "Kayıt olmak için tıkla!", complationText: "Giriş Yap") {
                dataModel.loginUser()
            } isLoginAction: {
            ...
            BasicEntry(username: $dataModel.username, password: $dataModel.password, loginActionText: "Giriş yapmak için tıklayın!", complationText: "Kayıt Ol") {
